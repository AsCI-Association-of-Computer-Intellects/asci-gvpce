...
const Team = () => {
  ...
  const availableSeasons = Object.keys(teamSeasons);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 flex justify-center">
          <div className="flex flex-col items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-5 py-4 shadow-xl shadow-black/20 backdrop-blur-sm sm:flex-row sm:gap-4">
            ...
            >
              <option value={latestSeason}>{teamSeasons[latestSeason].label}</option>
            </select>
          </div>
        </div>
  ...
  return (
    <section id="team" className="py-20 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 flex justify-center">
          <div className="flex flex-col items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-5 py-4 shadow-xl shadow-black/20 backdrop-blur-sm sm:flex-row sm:gap-4">
            ...
            <select
              ...
              className="min-w-[220px] rounded-xl border border-white/10 bg-gray-950 px-4 py-3 text-base font-semibold text-white outline-none transition focus:border-blue-400"
            >
              <option value="2025-26">Team 2025-26</option>
              <option value="2024-25">Team 2024-25</option>
            </select>
          </div>
        </div>
              ...
              >
                ...
                <div className="p-8 text-center">
                  <h4
                    className="text-2xl font-bold text-white mb-2 transition-colors duration-300"
                    onMouseEnter={(e) => {
                      (e.currentTarget as HTMLElement).style.color = faculty.borderColor;
                    }}
                    onMouseLeave={(e) => {
        ...
        <div className="mb-20">
          <h3 className="text-3xl font-bold text-white mb-10 text-center">Core Team - {selectedTeam.label}</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {selectedTeam.coreTeam.map((member, index) => (
              <div
                key={index}
              ...
              >
                ...
                <div className="p-6 text-center" style={{ background: "linear-gradient(145deg, rgba(31, 41, 55, 0.8), rgba(17, 24, 39, 0.8))" }}>
                  <h4 className="text-xl font-bold text-white mb-1 group-hover:text-blue-400 transition-colors duration-300">{member.name}</h4>
                  <p className="font-semibold" style={{ color: member.borderColor }}>{member.role}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div>
          <h3 className="text-3xl font-bold text-white mb-10 text-center">Domain Leads - {selectedTeam.label}</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {selectedTeam.domainLeads.map((member, index) => (
              <div
                key={index}
                className="group rounded-2xl overflow-hidden shadow-lg transition-all duration-500 transform hover:-translate-y-3 border-2"
                style={{ borderColor: member.borderColor, boxShadow: `0 10px 40px -10px ${member.borderColor}40, 0 0 20px -5px ${member.borderColor}20` }}
              >
                <div className="relative h-84 overflow-hidden" style={{ background: member.gradient }}>
                  {renderMemberImage(member)}
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{ background: `linear-gradient(to top, ${member.borderColor}cc, transparent)` }}>
                    <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-3">
                      {member.url && (
                        <a
                          href={member.url}
                ...
                <div className="p-6 text-center" style={{ background: "linear-gradient(145deg, rgba(31, 41, 55, 0.8), rgba(17, 24, 39, 0.8))" }}>
                  <h4 className="text-lg font-bold text-white mb-1 group-hover:transition-colors duration-300" onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.color = member.accentColor || '#FFFFFF'; }} onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.color = '#FFFFFF'; }}>{member.name}</h4>
                  <p className="font-semibold text-sm" style={{ color: member.borderColor }}>{member.role}</p>
                </div>
              </div>
            ))}
          </div>
