...
const Team = () => {
  ...
  const facultyCoordinators = [
    {
      image: assetPath("photos/hod.png"),
    ...
    {
      image: assetPath("photos/KBMadhuri.jpg"),
    ...
    {
      image: assetPath("photos/Ajay.jpg"),
      title: "Ajay Kumar",
    ...
    {
      image: assetPath("photos/seetalakshmi.jpg"),
    ...
    {
      image: assetPath("photos/leteefa.jpg"),
      title: "Lateefa",
      subtitle: "Assistant Professor, Dept of CSE",
      handle: "@lateefa",
      ...
      coreTeam: [
        {
          name: "Bagadi Bharat",
          role: "President",
          image: assetPath("photos/2025-26/BHARAT.jpg"),
        ...
        },
        {
          ...
          role: "Vice President",
          image: assetPath("photos/2025-26/rushitha.jpg"),
        ...
        },
        {
          name: "A.Uhanjani",
          role: "Secretary",
          image: assetPath("photos/2025-26/Uha.jpg"),
        ...
        },
        {
          ...
          role: "Treasurer",
          image: assetPath("photos/2025-26/CHARAN.png"),
      ...
      domainLeads: [
        {
          ...
          image: assetPath("photos/2025-26/Yeswanth.jpg"),
        ...
        },
        {
          ...
          image: assetPath("photos/2025-26/SIRI.jpg"),
        ...
        },
        {
          ...
          role: "Designing Lead",
          image: assetPath("photos/2025-26/LILLY.png"),
        ...
        },
        {
          ...
          image: assetPath("photos/2025-26/BHARGAVI.jpg"),
        ...
        },
        {
          ...
          image: assetPath("photos/2025-26/SARAT.jpg"),
        ...
        },
        {
          ...
          image: assetPath("photos/2025-26/PRASANNA.jpg"),
        ...
        },
        {
          ...
          image: assetPath("photos/2025-26/SANJANA.jpg"),
        ...
        },
        {
          ...
          image: assetPath("photos/poojitha.jpg"),
        ...
        },
        {
          ...
          image: assetPath("photos/2025-26/THANUSRI.jpg"),
        ...
        },
        {
          ...
          image: assetPath("photos/2025-26/MANIDEEPAK.jpg"),
        ...
        },
        {
          ...
          image: assetPath("photos/2025-26/Aparna.jpg"),
        ...
        },
        {
          ...
          image: assetPath("photos/kushal.jpg"),
      ...
      coreTeam: [
        {
          name: "Lavanya",
          role: "President",
          image: assetPath("photos/lavanya.jpg"),
        ...
        },
        {
          name: "Aravind",
          role: "Vice President",
          image: assetPath("photos/aravind.jpg"),
        ...
        },
        {
          name: "Fathima",
          role: "Secretary",
          image: assetPath("photos/fathima.jpg"),
        ...
        },
        {
          name: "Laxmi",
          role: "Treasurer",
          image: assetPath("photos/laxmi.jpg"),
      ...
      domainLeads: [
        {
          name: "Moenuddin",
          role: "Blockchain Lead",
          image: assetPath("photos/moenuddin.jpg"),
        ...
        },
        {
          ...
          image: assetPath("photos/asmitha.jpg"),
        ...
        },
        {
          ...
          image: assetPath("photos/prasanna.jpg"),
          borderColor: "#EC4899",
          gradient: "linear-gradient(145deg, #EC4899, #000)",
          accentColor: "#F472B6",
        },
        {
          ...
          image: assetPath("photos/vamsi.jpg"),
          borderColor: "#A855F7",
          gradient: "linear-gradient(145deg, #A855F7, #000)",
          accentColor: "#D8B4FE",
        },
        {
          name: "Navya Sri",
          role: "Data Analytics Lead",
          image: assetPath("photos/navyasri.jpg"),
          borderColor: "#F97316",
          gradient: "linear-gradient(145deg, #F97316, #000)",
          accentColor: "#FB923C",
        },
        {
          name: "Lakshmi Raj",
          role: "DSA Lead",
          image: assetPath("photos/lakshmiraj.jpg"),
        ...
        },
        {
          ...
          image: assetPath("photos/varma.jpg"),
        ...
        },
        {
          name: "Yamini",
          role: "Designing Lead",
          image: assetPath("photos/yamini.jpg"),
        ...
        },
        {
          ...
          image: assetPath("photos/suvarna.jpg"),
        ...
        },
        {
          ...
          image: assetPath("photos/harisai.jpg"),
  ...
  const availableSeasons = Object.keys(teamSeasons).sort((left, right) => {
    const leftYear = parseInt(left.split("-")[0], 10);
    const rightYear = parseInt(right.split("-")[0], 10);
    return leftYear - rightYear;
  });

  const currentAcademicSeason = (() => {
  ...
  const initialSeason = teamSeasons[currentAcademicSeason] ? currentAcademicSeason : latestSeason;
  const [selectedSeason, setSelectedSeason] = useState(initialSeason);
  const selectedTeam = teamSeasons[selectedSeason] ?? teamSeasons[latestSeason];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 flex justify-center">
          <div className="flex flex-col items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-5 py-4 shadow-xl shadow-black/20 backdrop-blur-sm sm:flex-row sm:gap-4">
            ...
            >
              <option value={selectedTeam.label}>{selectedTeam.label}</option>
            </select>
          </div>
        </div>
            ...
            {facultyCoordinators.map((faculty, index) => (
              ...
              >
                ...
                <div className="p-8 text-center">
                  ...
                  <p className="font-semibold text-lg mb-1" style={{ color: faculty.borderColor }}>
                    {faculty.subtitle}
                  </p>
        ...
        <div className="mb-20">
          <h3 className="text-3xl font-bold text-white mb-10 text-center">
            Core Team - {selectedTeam.label}
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {selectedTeam.coreTeam.map((member, index) => (
              <div
                key={index}
              ...
              >
                <div className="relative h-96 overflow-hidden" style={{ background: member.gradient }}>
        ...
        <div>
          <h3 className="text-3xl font-bold text-white mb-10 text-center">
            Domain Leads - {selectedTeam.label}
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {selectedTeam.domainLeads.map((member, index) => (
              <div
                key={index}
                className="group rounded-2xl overflow-hidden shadow-lg transition-all duration-500 transform hover:-translate-y-3 border-2"
                style={{
              ...
              >
                <div className="relative h-84 overflow-hidden" style={{ background: member.gradient }}>
                  {renderMemberImage(member)}
                  <div
